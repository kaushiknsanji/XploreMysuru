...
package com.example.kaushiknsanji.xploremysuru.workers;
...
/**
 * Headless {@link Fragment} that manages decoding of Images for the
 * Resource Ids pointing to the Graphic Images stores in 'res' directory.
 * <p>
 * <p>Images are decoded only when not present in the {@link BitmapImageCache}</p>
