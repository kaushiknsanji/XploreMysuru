 ...
 * that inflates the layout 'R.layout.layout_main_content_page' to display a list of Shops
 * configured in the Resources. This implements the {@link ShopListContract.View} on the
