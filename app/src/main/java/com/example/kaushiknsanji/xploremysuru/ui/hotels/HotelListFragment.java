 ...
 * that inflates the layout 'R.layout.layout_main_content_page' to display a list of Hotels
 * configured in the Resources. This implements the {@link HotelListContract.View} on the
