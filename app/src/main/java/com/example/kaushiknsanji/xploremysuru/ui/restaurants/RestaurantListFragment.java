 ...
 * that inflates the layout 'R.layout.layout_main_content_page' to display a list of Restaurants
 * configured in the Resources. This implements the {@link RestaurantListContract.View} on the
