 ...
 * that inflates the layout 'R.layout.layout_main_content_page' to display a list of Places
 * configured in the Resources. This implements the {@link PlaceListContract.View} on the
