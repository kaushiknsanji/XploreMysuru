...
package com.example.kaushiknsanji.xploremysuru.extensions;
...
/**
 * Custom {@link CoordinatorLayout.Behavior} for {@link BottomNavigationView} component.
 * <p>
 * <p><ol>
 * <li>The Behavior hides away the BottomNavigationView when the user scrolls towards the bottom
 * of the View, shown for the Navigation item selected.</li>
 * <li>The Behavior checks for the {@link Snackbar} dependency and adjusts its layout parameters such that
 * the Snackbar always appears above the BottomNavigationView.</li>
 * <li>The Behavior mimics the Snap behavior of the {@link android.support.design.widget.AppBarLayout}
 * for displaying/hiding the BottomNavigationView on scrolling.</li>
 * </ol></p>
 *
