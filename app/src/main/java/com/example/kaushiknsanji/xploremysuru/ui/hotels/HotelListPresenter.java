...
/**
 * The Presenter Class that implements the {@link HotelListContract.Presenter} on the lines of
 * Model-View-Presenter architecture. This Presenter interfaces with the App repository {@link AppRepository}
 * and provides a list of Hotels configured to the View {@link HotelListFragment} to load
